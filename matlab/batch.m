...
for filenum=1:length(filesdev1_tdoa)
    ...
    [doa_meters(filenum*3-2), doa_samples(filenum*3-2), doa_meters_2(filenum*3-2), doa_samples_2(filenum*3-2), correlation_value(1,:,filenum), correlation_value_interp(1,:,filenum)] = ...
        tdoa2(signal1, signal2, num_samples_per_freq, num_samples_per_slice, sampling_rate_tdoa, rx_distance_diff12, smoothing_factor, corr_type, report_level, signal_bandwidth_khz, interpol_factor);
    ...
    [doa_meters(filenum*3-1), doa_samples(filenum*3-1), doa_meters_2(filenum*3-1), doa_samples_2(filenum*3-1), correlation_value(2,:,filenum), correlation_value_interp(2,:,filenum)] = ...
        tdoa2(signal1, signal3, num_samples_per_freq, num_samples_per_slice, sampling_rate_tdoa, rx_distance_diff13, smoothing_factor, corr_type, report_level, signal_bandwidth_khz, interpol_factor);
    ...
    [doa_meters(filenum*3), doa_samples(filenum*3), doa_meters_2(filenum*3), doa_samples_2(filenum*3), correlation_value(3,:,filenum), correlation_value_interp(3,:,filenum)] = ...
        tdoa2(signal2, signal3, num_samples_per_freq, num_samples_per_slice, sampling_rate_tdoa, rx_distance_diff23, smoothing_factor, corr_type, report_level, signal_bandwidth_khz, interpol_factor);
end
