...
%         file3 = filesdev3_ltess(filenum).name;
        ...
        disp('File 2 Successfully loaded');
%         signal3_ltess = spec_load([folder_identifier, 's3/', file3]);
%         disp('File 3 Successfully loaded');
...
%     [doa_meters(filenum*2), doa_samples(filenum*2), doa_meters_2(filenum*2), doa_samples_2(filenum*2), correlation_value(2,:,filenum), correlation_value_interp(2,:,filenum)] = ...
%         tdoa2(signal1, signal3, num_samples_per_freq, num_samples_per_slice, sampling_rate_tdoa, 0, smoothing_factor, corr_type, report_level, signal_bandwidth_khz, interpol_factor);
% 
%     disp(' ');
%     disp('______________________________________________________________________________________________');
