...
% smoothing_factor
    ...
    switch corr_strategy
        ...
        case 'dphase'
            ...
            d_phase1(isnan(d_phase1))=0;
            d_phase2(isnan(d_phase2))=0;
        ...
        case 'iq'
            iq_corr = abs(xcorr(iq1, iq2, 'coeff'));
            
            ref1 = max(abs(xcorr(iq1, iq1, 'coeff')));
            ref2 = max(abs(xcorr(iq2, iq2, 'coeff')));
            corr_max = max(iq_corr);
            disp(['IQ Korrelation, max ' num2str(corr_max) ', ref1 = ' num2str(ref1) ', ref2= ' num2str(ref2) ', => ' num2str(100*2*corr_max / (ref1+ref2)) '%'  ]);
