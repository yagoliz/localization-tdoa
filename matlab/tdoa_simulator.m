...
for ii = 1:NUM_HYPERBOLAS
    ...
    doa_s1_s2 = sensordist(sensor_1) - sensordist(sensor_2) + (20*rand(1)-10);
...
set(gca,'YDir','normal')
h = surf(heat_x, fliplr(heat_y), rot90(log10(mse_doa))); view(2); c = colorbar; colormap jet;
c.Label.String = 'log_{10}(MSE^{-1})';
