...
function [PPM, PPM2] = ltess(chunk, SAMPLING_RATE_LTESS)
...
% First run
[PPM,PSS_percent,~,~,~,PPM2] = getDrift(chunk,SAMPLING_RATE_LTESS, Z, Z_t, PREAMBLE, ...
...
[PPM,~,~,~,~,PPM2, ~, ~, ~, ~ ] = getDrift(chunk,SAMPLING_RATE_LTESS, Z, Z_t_rotated, ...
