function tdoa_res = tdoa_localization_samples(config)
...
us_slice = problem_data.config.samples_slice;
...
for ii = 1:N
    ...
    [doa_meters(ii), doa_samples(ii), doa_meters2(ii), doa_samples2(ii), ~, ~] = ...
        tdoa_samples(signal_local{si}, signal_local{sj}, ns_freq, ns_slice, us_slice, sr_local, rs_diff_ij, ...
